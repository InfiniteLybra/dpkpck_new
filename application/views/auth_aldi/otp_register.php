...
<body id="kt_body" class="app-blank bgi-size-cover bgi-attachment-fixed bgi-position-center">
                 ...
                 shadow">
                    ...
                    <div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
                        ...
                        <div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
                            <!--begin::Form-->
                            <form class="form w-100" action="<?= base_url('auth/register_verifikasi') ?>" method="post" id="myForm">
                                <!--begin::Heading-->
                                ...
                                <div class="fv-row mb-8">
                                    <!--begin::Email-->
                                    <div class="text-gray">Masukkan kode OTP</div>
                                    <input type="hidden" name="nik" required value="<?= $nik ?>" />
                                    <input type="hidden" name="username" required value="<?= $username ?>" />
                                    <input type="text" id="otp" placeholder="masukkan kode otp" name="otp" autocomplete class="form-control bg-transparent" required />
                                    <!--end::Email-->
                                </div>
                                <!--end::Input group=-->
                                <!--begin::Submit button-->
                                ...
                                <div class="text-gray-500 text-center fw-semibold fs-6">
                                    Cek WhatApp anda. <br> Jika kode OTP belum masuk, harap hubungi Admin.
                                </div>
                                <!--end::Sign up-->
                            </form>
                            <!--end::Form-->
    ...
    <script>
        document.getElementById("myForm").addEventListener("submit", function(e) {
            ...
            var kode = document.getElementById("otp").value;

            // Memeriksa apakah nilai input adalah "qkwqw"
            if (kode !== "<?= $kode ?>") {
                // alert("Kode yang Anda masukkan salah. Silakan masukkan kode yang benar (qkwqw).");
                toastr.error("Kesalaahan, Kode yang anda masukkan salah.");
            } else {
                // Lakukan pengiriman formulir atau tindakan lain di sini
                // alert("Formulir telah berhasil dikirim.");
                // toastr.success("Sukses, O.");
                this.submit(); // Melanjutkan pengiriman formulir
            }
        });
    </script>
    <!--end::Javascript-->
