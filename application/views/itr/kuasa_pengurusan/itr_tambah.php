...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="stepper stepper-links d-flex flex-column pt-15" id="kt_create_account_stepper">
            ...
            <!--end::Nav-->
            <!--begin::Form-->
            <form class="mx-auto mw-800px w-100 pt-15 pb-10" id="kt_create_account_form" method="POST" action="<?php echo base_url('Itr/proses_tambah_itr_kuasa_pengurusan'); ?>" enctype="multipart/form-data">
                <!--begin::Step 1-->
                    ...
                    <div class="w-100">
                        <div class="mb-3 row">
                            <h6 style="text-align: justify;">
                                Dengan tetap mematuhi persyaratan-persyaratan yang ditetapkan sesuai ketentutan peraturan yang berlaku.
                                Dengan Surat Kuasa ini kami buat dengan sebenar-benarnya, untuk dipergunakan sebagaimana perlunya.
                            </h6>
                        </div>
                    </div>
                </div> -->
