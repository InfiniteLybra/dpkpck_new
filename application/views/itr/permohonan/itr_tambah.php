                            ...
                            <form class="mx-auto mw-800px w-100 pt-15 pb-10" id="kt_create_account_form" method="POST" action="<?php echo base_url('Itr/proses_tambah_itr_permohonan'); ?>" enctype="multipart/form-data">
                                ...
                                <div data-kt-stepper-element="content">
                                    <div class="w-100">
                                        ...
                                        <div class="mb-3 row">
                                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Surat Kuasa Dari
                                                Pemilik Tanah
                                                <span class="required"></span>
                                            </label>
                                            <div class="col-md-9 col-sm-9 ">
                                                <input type="file" id="alamat-pemohon" name="surat_kuasa" class="form-control ">
                                        ...
                                        <div class="mb-3 row">
                                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Fotokopi akte
                                                pendidikan perusahaan dan fotokopi NPWP
                                                <br><small>(jika berbadan hukum dan wajib untuk permohonan degan
                                                    luas total diatas 1
                                                    Ha)</small>
                                                <span class="required"></span>
                                            </label>
                                            <div class="col-md-9 col-sm-9 ">
                                                <input type="file" id="alamat-pemohon" name="akte_pendidikan" class="form-control ">
