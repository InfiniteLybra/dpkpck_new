                        ...
                        <div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
                            ...
                            <form class="form w-100" action="<?= base_url('auth/proses_register') ?>" method="post">
                                ...
                                <div class="fv-row mb-8">
                                    ...
                                    <div class="text-gray">Kode OTP</div>
                                    <input id="otp" placeholder="xxxxxx" name="otp" type="password" autocomplete class="form-control bg-transparent" oninput="this.value = this.value.replace(/[^0-9]/g, '')" />
                                    <!--end::Repeat Password-->
                                </div>
                                <div class="d-grid mb-10">
                                <!-- <input type="submit" name="sendAgain" value="Send Request OTP" class=btn btn-light><a href=""></a> -->
                                    <button type="submit" id="sendAgain" class="btn btn-light" name="sendAgain" >
                                        <!--begin::Indicator label-->
                                        <span class="indicator-label">Kirim ulang kode Verifikasi</span>
                                        <!--end::Indicator label-->
                                    </button>
                                </div>
                                <input id="nomor" value="<?= $this->session->userdata('nomor_telepon') ?>" placeholder="xxxxxx" name="nomor" type="hidden" autocomplete class="form-control bg-transparent" />
                        </div>
                        <!--end::Input group=-->
                        <!--begin::Submit button-->
                        <div class="d-grid mb-10">
                            <button type="submit" id="submitButton" class="btn btn-primary" name="otpButton">
                                <!--begin::Indicator label-->
                                <span class="indicator-label">Verification</span>
                                <!--end::Indicator label-->
                            </button>
                        </div>
                        <!--end::Submit button-->
