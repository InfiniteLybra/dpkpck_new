...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/map'); ?>Control.FullScreen.css" />
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        <div class="app-brand demo">
          <a href="#" class="app-brand-link">
            <span class="app-brand-logo demo ms-5 me-5">
              <img src="<?php echo base_url('assets/'); ?>assets/img/Logo_E-Pora.png" width="100x">
            </span>
          </a>
        ...
        <?php if ($this->session->userdata('level') == 6) { ?>
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="<?= base_url('Filter.html') ?>" class="menu-link">
            ...
            <!-- <li class="menu-item">
              <a href="<?= base_url('Map/index2') ?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-map-alt"></i>
                <div data-i18n="SHP Map">SHP Map</div>
              </a>
            </li> -->
