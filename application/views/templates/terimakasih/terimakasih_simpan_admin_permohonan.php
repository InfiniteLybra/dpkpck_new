            ...
            <div class="card">
                <div class="card-body my-5 px-5">
                    <div class="text-center">
                        ...
                        <h2 class="fw-bold mt-3 mb-2">Terima Kasih!</h2>
                        <h4 class="fw-bold">Data Anda berhasil disimpan.</h4>
                        <?php $previousPage = $this->session->userdata('detail_admin_kkpr'); ?>
                        ...
                        <a href="<?php echo $previousPage?>" class="btn btn-primary">Kembali </a>
                    </div>
                </div>
            </div>
        </div>
