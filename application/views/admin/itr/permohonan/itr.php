<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Admin / ITR / </span>Admin Permohonan</h4>
                            ...
                            <tbody class="text-center">
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center pe-0">
                                            <span class="fw-bold">Peternakan</span>
                                        </td>
                                        <td class="text-center pe-0">
                                            <a href="<?php echo base_url('Itr/detail_itr/'); ?><?= $i->id_itr ?>" class="btn btn-primary btn-sm">Detail</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
