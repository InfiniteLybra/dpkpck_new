                ...
                <tbody class="text-center">
                    ...
                    <tr>
                        ...
                        <td class="text-center pe-0">
                            ...
                            if ($cek) {
                            ?>
                                <select name="perda_rtr1" id="perda_rtr1" class="form-select form-control mb-2" data-control="select2" data-placeholder="Mohon Pilh...">
                    ...
                    <tr>
                        ...
                        <td class="text-center pe-0">
                            <?php if ($cek) { ?>
                                <select name="perda_rtr2" id="perda_rtr2" class="form-select form-control mb-2" data-control="select2" data-placeholder="Mohon Pilh...">
                                    <option value="" selected></option>
                                    <option value="999">-</option>
                                    <?php
                                    $perda_query = $this->db->query("SELECT * FROM pilihan WHERE id_pilihan = '7'")->row();
                    ...
                    <tr>
                        ...
                        <td class="text-center pe-0">
                            <?php if ($cek) { ?>
                                <select name="perda_rtr3" id="perda_rtr3" class="form-select form-control mb-2" data-control="select2" data-placeholder="Mohon Pilh...">
                                    <option value="" selected></option>
                                    <option value="999">-</option>
                                    <?php
                                    $perda_query = $this->db->query("SELECT * FROM pilihan WHERE id_pilihan = '7'")->row();
                    ...
                    <tr>
                        ...
                        <td class="text-center pe-0">
                            ...
                            ?>
                            <div class="d-flex">
                            <input type="text" name="diijinkan_sebagian" class="form-control flex-grow-1" value="">
                            <button class="btn btn-light fw-bold flex-shrink-0" disabled>m2</button>
                            </div>
                            <?php } 
                            ?>
                    ...
                    <tr>
                        ...
                        <td class="text-center pe-0">
                            ...
                            <?php } else { 
                            ?>
                            <input type="text" name="indikasi_ppr" class="form-control" value="">
                            <?php } 
                            ?>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="text-center pe-0">
                            <?php if ($cek) { ?>
                                <div class="d-flex">
                                <input type="text" name="luas_tanah_disetujui" class="form-control flex-grow-1" value="<?= $data->luas_disetujui ?>">
                                <button class="btn btn-light fw-bold flex-shrink-0" disabled>m2</button>
                                </div>
                            <?php } else { ?>
                                <div class="d-flex">
                                <input type="text" name="luas_tanah_disetujui" class="form-control flex-grow-1" value="">
                                <button class="btn btn-light fw-bold flex-shrink-0" disabled>m2</button>
                                </div>
                            <?php } ?>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="text-center pe-0">
                            <?php if ($cek) { ?>
                                <div class="d-flex">
                                <input type="text" name="koefisien_bangunan" class="form-control flex-grow-1" value="<?= $data->koefisien_bangunan ?>">
                                <button class="btn btn-light fw-bold flex-shrink-0" disabled>m2</button>
                                </div>
                            <?php } else { ?>
                                <div class="d-flex">
                                <input type="text" name="koefisien_bangunan" class="form-control flex-grow-1" value="">
                                <button class="btn btn-light fw-bold flex-shrink-0" disabled>m2</button>
                                </div>
                            <?php } ?>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="text-center pe-0">
                            <?php if ($cek) { ?>
                                <div class="d-flex">
                                <input type="text" name="koefisien_dasar_hijau" class="form-control flex-grow-1" value="<?= $data->koefisien_dasar_hijau ?>">
                                <button class="btn btn-light fw-bold flex-shrink-0" disabled>m2</button>
                                </div>
                            <?php } else { ?>
                                <div class="d-flex">
                                <input type="text" name="koefisien_dasar_hijau" class="form-control flex-grow-1" value="">
                                <button class="btn btn-light fw-bold flex-shrink-0" disabled>m2</button>
                                </div>
                            <?php } ?>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="text-center pe-0">
                            <?php if ($cek) { ?>
                                <div class="d-flex">
                                <input type="text" name="gsp_gsb" class="form-control flex-grow-1" value="<?= $data->gsp_gsb ?>">
                                <button class="btn btn-light fw-bold flex-shrink-0" disabled>m2</button>
                                </div>
                            <?php } else { ?>
                                <div class="d-flex">
                                <input type="text" name="gsp_gsb" class="form-control flex-grow-1" value="">
                                <button class="btn btn-light fw-bold flex-shrink-0" disabled>m2</button>
                                </div>
                            <?php } ?>
                        </td>
