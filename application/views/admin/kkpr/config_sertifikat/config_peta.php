                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?php } else { ?>
                                                        <input type="text" name="nomor" class="form-control" value="650/000<?php $data->id_kkpr_permohonan ?>/35.07.111/<?= date("Y"); ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($cek) { ?>
                                                        <input type="text" name="nama_pemohon" id="nama_pemohon" class="form-control" value="<?= $data->nama_pemohon ?>">
                                                    <?php } else { ?>
                                                        <input type="text" name="nama_pemohon" id="nama_pemohon" class="form-control" value="<?= $data->nama_pemohon ?>">
                                                    <?php } ?>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($cek) { ?>
                                                        <textarea class="form-control" name="alamat_pemohon" id="alamat_pemohon" data-kt-autosize="true"><?php if ($data) echo $data->alamat_pemohon ?> </textarea>
                                                    <?php } else { ?>
                                                        <textarea class="form-control" name="alamat_pemohon" id="alamat_pemohon" data-kt-autosize="true"><?php if ($data) echo $data->alamat_pemohon ?> RT. <?php if ($data) echo $data->rt_pemohon ?> RW. <?php if ($data) echo $data->rw_pemohon ?> Kel. <?= $kelurahan->subdis_name ?> - Kec. <?= $kecamatan->dis_name ?> - Kota / Kab. <?= $kota->city_name ?> - Prov. <?= $provinsi->prov_name ?></textarea>
                                                    <?php } ?>
                                                </td>
                                            </tr>
                                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($cek) { ?>
                                        ...
                                        <input type="text" name="koefisien_bangunan" id="koefisien_bangunan" class="form-control" value="<?php if ($data->koefisien_bangunan) {
                                                                                                                                                echo $data->koefisien_bangunan;
                                                                                                                                            } else {
                                                                                                                                                echo isset($draft_data['koefisien_bangunan']) ? $draft_data['koefisien_bangunan'] : '';
                                                                                                                                            } ?>">
                                    <?php } else { ?>
                                        <input type="text" name="koefisien_bangunan" id="koefisien_bangunan" class="form-control" value="<?php if (isset($draft_data['koefisien_bangunan'])) {
                                                                                                                                                echo isset($draft_data['koefisien_bangunan']) ? $draft_data['koefisien_bangunan'] : '';
                                                                                                                                            } else {
                                                                                                                                                echo ' %=  m²';
                                                                                                                                            } ?>">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($cek) { ?>
                                        ...
                                        <input type="text" name="koefisien_dasar_hijau" id="koefisien_dasar_hijau" class="form-control" value="<?php if ($data->koefisien_dasar_hijau) {
                                                                                                                                                    echo $data->koefisien_dasar_hijau;
                                                                                                                                                } else {
                                                                                                                                                    echo isset($draft_data['koefisien_dasar_hijau']) ? $draft_data['koefisien_dasar_hijau'] : '';
                                                                                                                                                } ?>">
                                    <?php } else { ?>
                                        <input type="text" name="koefisien_dasar_hijau" id="koefisien_dasar_hijau" class="form-control" value="<?php if (isset($draft_data['koefisien_dasar_hijau'])) {
                                                                                                                                                    echo isset($draft_data['koefisien_dasar_hijau']) ? $draft_data['koefisien_dasar_hijau'] : '';
                                                                                                                                                } else {
                                                                                                                                                    echo ' %=  m²';
                                                                                                                                                } ?>">
