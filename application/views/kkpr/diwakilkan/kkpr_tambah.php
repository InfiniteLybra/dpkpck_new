            ...
            <div class="col-md-12"><!--begin::Card-->
                <div class="card">
                    ...
                    <h3 class="stepper-title">Pernyataan</h3>
                            ...
                            <!--end::Nav-->
                            <!--begin::Form-->
                            <form class="mx-auto mw-800px w-100 pt-15 pb-10" id="kt_create_account_form" method="POST" action="<?php echo base_url('Kkpr/proses_tambah_diwakilkan'); ?>" enctype="multipart/form-data">
                                <!--begin::Step 1-->
