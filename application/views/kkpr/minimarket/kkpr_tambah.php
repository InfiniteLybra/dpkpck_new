...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="stepper stepper-links d-flex flex-column pt-15" id="kt_create_account_stepper">
            ...
            <!--end::Nav-->
            <!--begin::Form-->
            <form class="mx-auto mw-800px w-100 pt-15 pb-10" id="kt_create_account_form" method="POST" action="<?php echo base_url('Kkpr/proses_tambah_kkpr_minimarket'); ?>" enctype="multipart/form-data">
                <!--begin::Step 1-->
                ...
                <div data-kt-stepper-element="content">
                    <div class="w-100">
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                <input type="file" id="alamat-pemohon" name="surat_dinas_perdagangan" class="form-control ">
                            </div>
                        </div>
                        <div class="mb-3 row">
