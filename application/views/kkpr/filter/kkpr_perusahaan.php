            ...
            <div class="card mb-4">
                ...
                <form class="mt-3" c id="msform" action="<?php echo base_url('Kkpr/insert_kkpr'); ?>" enctype="multipart/form-data">
                    ...
                    <ul id="progressbar">
                        ...
                        <li id="confirm"><strong>Data Perusahaan</strong></li>
                    ...
                    <fieldset>
                        <div class="card-body">
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="nama-pemohon">Bertindak Atas
                                    Nama
                                    <br><small>(PT,CV,Yayasan / dll)</small>
                                    <span class="required">*</span>
                                </label>
                                <div class="col-md-10">
                                    <input type="text" id="nama_perusahaan" class="form-control " value="<?php if ($kkpr) {
                                                                                                                echo $kkpr->nama_perusahaan;
                                                                                                            } else {
                                                                                                                echo isset($draft_data['nama_perusahaan']) ? $draft_data['nama_perusahaan'] : '';
                                                                                                            } ?>" required="required" data-validate-length-range="6" name="nama_perusahaan" placeholder="Ex. CV.Cipta Karya">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="nama-pemohon">
                                    Nomor Induk Berusaha (NIB)
                                    <span class="required">*</span>
                                </label>
                                <div class="col-md-10">
                                    <input type="number" id="nib" class="form-control " value="<?php if ($kkpr) {
                                                                                                    echo $kkpr->nib;
                                                                                                } else {
                                                                                                    echo isset($draft_data['nib']) ? $draft_data['nib'] : '';
                                                                                                } ?>" required="required" data-validate-length-range="6" name="nib" placeholder="Ex. 1234567890123">
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="last-name">KBLI diMohon
                                </label>
                                <div class="col-md-10">
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="last-name">Alamat
                                    <br><small>(sesuai NPWP / NIB)</small>
                                    <span class="required">*</span>
                                </label>
                                <div class="col-md-10">
                                    <input type="text" id="alamat_perusahaan" value="<?php if ($kkpr) {
                                                                                            echo $kkpr->alamat_perusahaan;
                                                                                        } else {
                                                                                            echo isset($draft_data['alamat_perusahaan']) ? $draft_data['alamat_perusahaan'] : '';
                                                                                        } ?>" name="alamat_perusahaan" required="required" class="form-control " placeholder="Ex. Jl.Kebon Raya blok 3A No.01">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="middle-name" class="col-sm-2 col-form-label">RT
                                    <span class="required">*</span></label>
                                <div class="col-md-10">
                                    <input id="rt_perusahaan" class="form-control col" value="<?php if ($kkpr) {
                                                                                                    echo $kkpr->rt_perusahaan;
                                                                                                } else {
                                                                                                    echo isset($draft_data['rt_perusahaan']) ? $draft_data['rt_perusahaan'] : '';
                                                                                                } ?>" type="number" placeholder="Ex. 001" min="1" max="20" name="rt_perusahaan" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="middle-name" class="col-sm-2 col-form-label">RW<span class="required">*</span></label>
                                <div class="col-md-10">
                                    <input id="rw_perusahaan" class="form-control col" value="<?php if ($kkpr) {
                                                                                                    echo $kkpr->rw_perusahaan;
                                                                                                } else {
                                                                                                    echo isset($draft_data['rw_perusahaan']) ? $draft_data['rw_perusahaan'] : '';
                                                                                                } ?>" type="number" placeholder="Ex. 001" min="1" max="20" name="rw_perusahaan" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label">Kota /
                                    Kabupaten
                                    <span class="required">*</span>
                                </label>
                                <div class="col-md-10">
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label">Kecamatan
                                    <span class="required">*</span>
                                </label>
                                <div class="col-md-10">
                            ...
                            <div class="row mb-3">
                                <label for="middle-name" class="col-sm-2 col-form-label">Desa /
                                    Kelurahan
                                    <span class="required">*</span>
                                </label>
                                <div class="col-md-10">
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="last-name"> Dokumen yang di unduh pada OSS
                                    <span class="required">*</span>
                                </label>
                                <div class="col-md-10">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <select name="status_tanah_sm" id="status_tanah_sm" class="form-select form-control mb-2">
                                        ...
                                        <option value="sewa" <?php if ($draft_data['status_tanah_sm']) {
                                                                    if ($draft_data['status_tanah_sm']  == 'sewa') {
                                                                        echo 'selected';
                                                                    }
                                                                } ?>>Sewa</option>
                                        <option value="milik_sendiri" <?php if ($draft_data['status_tanah_sm']) {
                                                                            if ($draft_data['status_tanah_sm']  == 'milik_sendiri') {
                                                                                echo 'selected';
                                                                            }
