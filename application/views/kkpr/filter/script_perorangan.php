...
<script>
    ...
    const selectElements = document.querySelectorAll('#skala_usaha,#klasifikasi_resiko,#status_tanah_sm,#perluasan,#id_st_1'); // Gantilah 'your_select_id_here' dengan ID elemen select Anda
