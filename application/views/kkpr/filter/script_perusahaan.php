...
<script>
    ...
    const inputElements = document.querySelectorAll('#nama_pemohon, #alamat_pemohon, #rt_pemohon, #rw_pemohon, #telp_pemohon,  #nama_kuasa, #alamat_kuasa, #rt_kuasa, #rw_kuasa, #telp_kuasa,  #nama_perusahaan,#alamat_perusahaan,#rt_perusahaan,#rw_perusahaan,#nib, #peruntukan_tanah,#luas_tanah,#lokasi_tanah,#rt_tanah,#rw_tanah');
