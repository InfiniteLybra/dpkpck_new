                        ...
                        <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                <label for="middle-name" class="col-sm-2 col-form-label">RT
                                    <span class="required">*</span></label>
                                <div class="col-md-10">
                                    <input id="rt_perusahaan" class="form-control col" value="<?php if($kkpr){echo $kkpr->rt_perusahaan;}else{echo isset($draft_data['rt_perusahaan']) ? $draft_data['rt_perusahaan'] : '';} ?>" type="number" placeholder="Ex. 001" min="1" max="20" name="rt_perusahaan" required>                                    
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="middle-name" class="col-sm-2 col-form-label">RW<span class="required">*</span></label>
                                <div class="col-md-10">
                                    <input id="rw_perusahaan" class="form-control col" value="<?php if($kkpr){echo $kkpr->rw_perusahaan;}else{echo isset($draft_data['rw_perusahaan']) ? $draft_data['rw_perusahaan'] : '';} ?>"  type="number" placeholder="Ex. 001" min="1" max="20" name="rw_perusahaan" required>                                    
                                </div>
                            </div>
                            <div class="row mb-3">
