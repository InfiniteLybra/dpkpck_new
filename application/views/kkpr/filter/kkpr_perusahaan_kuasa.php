                ...
                <div class="current" data-kt-stepper-element="content">
                    ...
                    <div class="w-100">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                <input type="file" id="alamat-pemohon" name="fotokopi_ktp" accept=".jpg, .pdf" class="form-control ">
                ...
                <div data-kt-stepper-element="content">
                    <div class="w-100">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                <input type="text" id="nama_kuasa" value="<?php if($kkpr){echo $kkpr->nama_kuasa;}else{echo  isset($draft_data['nama_kuasa']) ? $draft_data['nama_kuasa'] : '';} ?>" class="form-control mb-2 " name="nama_kuasa" placeholder="Ex. Wawan Supriyadi" required="required" />                                
                            </div>
                        </div>
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                <input type="text" id="alamat_kuasa" value="<?php if($kkpr){echo $kkpr->alamat_kuasa;}else{echo isset($draft_data['alamat_kuasa']) ? $draft_data['alamat_kuasa'] : '';} ?>" name="alamat_kuasa" required="required" class="form-control mb-2 " placeholder="Ex. Jl.Kebon Raya blok 3A No.01">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">RT<span class="required"></span></label>
                            <div class="col-md-9 col-sm-9 ">
                                <input id="rt_kuasa" value="<?php if($kkpr){echo $kkpr->rt_kuasa;}else{echo isset($draft_data['rt_kuasa']) ? $draft_data['rt_kuasa'] : '';} ?>" class="form-control mb-2 col" type="number" min="1" max="20" name="rt_kuasa" placeholder="Ex. 001" required>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">RW<span class="required"></span></label>
                            <div class="col-md-9 col-sm-9 ">
                                <input id="rw_kuasa" value="<?php if($kkpr){echo $kkpr->rw_kuasa;}else{echo isset($draft_data['rw_kuasa']) ? $draft_data['rw_kuasa'] : '';} ?>" class="form-control mb-2 col" type="number" placeholder="Ex. 001" min="1" max="20" name="rw_kuasa" required>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label class="col-form-label col-md-3 col-sm-3 label-align">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                <input id="telp_kuasa" value="<?php if($kkpr){echo $kkpr->telp_kuasa;}else{echo isset($draft_data['telp_kuasa']) ? $draft_data['telp_kuasa'] : '';} ?>" class="date-picker form-control mb-2" type="text" placeholder="Ex. 08998989809" name="telp_kuasa">
                                <small>(Cantumkan No Telp. / HP / WA Pemohon <b>Bukan</b> Kuasa
                                    pengurusan)</small>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                <input type="file" id="alamat-pemohon" name="fotokopi_ktp_kuasa" accept=".jpg, .pdf" class="form-control ">
                                <small>(File yang diterima hanya .jpg dan .pdf)</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="w-100">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                ...
                                <small>(File yang di terima hanya .jpg dan .pdf)</small>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="nama-pemohon">
                        ...
                        <div class="mb-3 row">
                            <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">RT<span class="required"></span></label>
                            <div class="col-md-9 col-sm-9 ">
                                <input id="rt_perusahaan" value="<?php if($kkpr){echo $kkpr->rt_perusahaan;}else{echo isset($draft_data['rt_perusahaan']) ? $draft_data['rt_perusahaan'] : '';} ?>" class="form-control col" type="number" placeholder="Ex. 001" min="1" max="20" name="rt_perusahaan" required>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">RW<span class="required"></span></label>
                            <div class="col-md-9 col-sm-9 ">
                                <input id="rw_perusahaan" value="<?php if($kkpr){echo $kkpr->rw_perusahaan;}else{echo isset($draft_data['rw_perusahaan']) ? $draft_data['rw_perusahaan'] : '';} ?>" class="form-control col" type="number" placeholder="Ex. 001" min="1" max="20" name="rw_perusahaan" required>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label class="col-form-label col-md-3 col-sm-3 label-align">
