                ...
                <div data-kt-stepper-element="content">
                    <div class="w-100">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                <input type="text" id="nama_kuasa" class="form-control mb-2 " name="nama_kuasa" placeholder="Ex. Wawan Supriyadi" required="required" />                                
                            </div>
                        </div>
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                <input type="text" id="alamat_kuasa" name="alamat_kuasa" required="required" class="form-control mb-2 " placeholder="Ex. Jl.Kebon Raya blok 3A No.01">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">RT<span class="required"></span></label>
                            <div class="col-md-9 col-sm-9 ">
                                <input id="middle-name" class="form-control mb-2 col" type="number" min="1" max="20" name="rt_kuasa" placeholder="Ex. 001" required>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">RW<span class="required"></span></label>
                            <div class="col-md-9 col-sm-9 ">
                                <input id="middle-name" class="form-control mb-2 col" type="number" placeholder="Ex. 001" min="1" max="20" name="rw_kuasa" required>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label class="col-form-label col-md-3 col-sm-3 label-align">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                <input id="birthday" class="date-picker form-control mb-2" type="text" placeholder="Ex. 08998989809" name="telp_kuasa">
                                <small>(Cantumkan No Telp. / HP / WA Pemohon <b>Bukan</b> Kuasa
                                    pengurusan)</small>
                            </div>
                        </div>
