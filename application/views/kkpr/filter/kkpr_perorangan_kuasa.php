        ...
        <div class="stepper stepper-links d-flex flex-column pt-15" id="kt_create_account_stepper">
            ...
            <div class="stepper-nav mb-5">
                ...
                <div class="stepper-item" data-kt-stepper-element="nav">
                    <h3 class="stepper-title">Data Kuasa</h3>
                </div>
                <!--end::Step 2-->
                <!--begin::Step 2-->
                <div class="stepper-item" data-kt-stepper-element="nav">
            ...
            <form class="mx-auto mw-800px w-100 pt-15 pb-10" id="kt_create_account_form" method="POST" action="<?php echo base_url('Kkpr/insert_kkpr'); ?>" enctype="multipart/form-data">
                    ...
                    <div class="w-100">                    
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                <input type="text" id="nama_pemohon" class="form-control mb-2 " name="nama_pemohon" value="<?php if($kkpr){echo $kkpr->nama_pemohon;}else{echo isset($draft_data['nama_pemohon']) ? $draft_data['nama_pemohon'] : '';} ?>" placeholder="Ex. Dr. Sarah Wijayanto, Esq." required="required" />
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                <input type="text" id="alamat_pemohon" name="alamat_pemohon" value="<?php if($kkpr){echo $kkpr->alamat_pemohon;}else{echo isset($draft_data['alamat_pemohon']) ? $draft_data['alamat_pemohon'] : '';} ?>" required="required" class="form-control mb-2 " placeholder="Ex. Jl.Kebon Raya blok 3A No.01">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">RT<span class="required"></span></label>
                            <div class="col-md-9 col-sm-9 ">
                                <input class="form-control mb-2 col" type="number" placeholder="Ex. 001" min="1" max="20" name="rt_pemohon" id="rt_pemohon" value="<?php if($kkpr){echo $kkpr->rt_pemohon;}else{echo isset($draft_data['rt_pemohon']) ? $draft_data['rt_pemohon'] : '';} ?>" required>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">RW<span class="required"></span></label>
                            <div class="col-md-9 col-sm-9 ">
                                <input class="form-control mb-2 col" type="number" placeholder="Ex. 001" min="1" max="20" name="rw_pemohon" id="rw_pemohon" value="<?php if($kkpr){echo $kkpr->rw_pemohon;}else{echo isset($draft_data['rw_pemohon']) ? $draft_data['rw_pemohon'] : '';} ?>" required>
                            </div>
                        </div>
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                <input id="telp_pemohon" class="date-picker form-control mb-2" type="text" name="telp_pemohon" value="<?php if($kkpr){echo $kkpr->telp_pemohon;}else{echo isset($draft_data['telp_pemohon']) ? $draft_data['telp_pemohon'] : '';} ?>" placeholder="Ex. 08998989809">
                ...
                <div data-kt-stepper-element="content">
                    <div class="w-100">
                        ...
                        <div class="mb-3 row">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="nama_perusahaan">Nama kuasa
                                <span class="required"></span>
                            </label>
                            <div class="col-md-9 col-sm-9 ">
                                <input type="text" id="nama_kuasa" class="form-control mb-2 " name="nama_kuasa" value="<?php if($kkpr){echo $kkpr->nama_kuasa;}else{echo isset($draft_data['nama_kuasa']) ? $draft_data['nama_kuasa'] : '';} ?>" placeholder="Ex. Wawan Supriyadi" required="required" />
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Alamat kuasa
                                <span class="required"></span>
                                <span class="ms-1" data-bs-toggle="tooltip" title="Ex. Jl.Kebon Raya blok 3A No.01">
                                    <i class="ki-duotone ki-information fs-7">
                                        <span class="path1"></span>
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                <input type="text" id="alamat_kuasa" name="alamat_kuasa" value="<?php if($kkpr){echo $kkpr->alamat_kuasa;}else{echo isset($draft_data['alamat_pemohon']) ? $draft_data['alamat_pemohon'] : '';} ?>" required="required" class="form-control mb-2 " placeholder="Ex. Jl.Kebon Raya blok 3A No.01">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">RT<span class="required"></span></label>
                            <div class="col-md-9 col-sm-9 ">
                                <input class="form-control mb-2 col" type="number" min="1" max="20" name="rt_kuasa" placeholder="Ex. 001" id="rt_kuasa" value="<?php if($kkpr){echo $kkpr->rt_kuasa;}else{echo isset($draft_data['rt_kuasa']) ? $draft_data['rt_kuasa'] : '';} ?>" required>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">RW<span class="required"></span></label>
                            <div class="col-md-9 col-sm-9 ">
                                <input class="form-control mb-2 col" type="number" placeholder="Ex. 001" min="1" max="20" name="rw_kuasa" id="rw_kuasa" value="<?php if($kkpr){echo $kkpr->rw_kuasa;}else{echo isset($draft_data['rw_kuasa']) ? $draft_data['rw_kuasa'] : '';} ?>" required>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label class="col-form-label col-md-3 col-sm-3 label-align">
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                <select name="provinsi_kuasa" id="provinsi_kuasa" class="form-select form-control mb-2" data-control="select2" data-placeholder="Pilih Provinsi">
                                    <option value="" selected></option>
                                    <?php foreach ($provinsi as $k) { ?>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                <select name="kota_kuasa" id="kota_kuasa" class="form-select form-control mb-2" data-control="select2" data-placeholder="Pilih Kota">
                                    <option value="" selected></option>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                <select name="kecamatan_kuasa" id="kecamatan_kuasa" class="form-select form-control mb-2" data-control="select2" data-placeholder="Pilih Kecamatan">
                                    <option value="" selected></option>
                        ...
                        <div class="mb-3 row">
                            <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Desa /
                                Kelurahan<span class="required"></span></label>
                            <div class="col-md-9 col-sm-9 ">
                                <select name="kelurahan_kuasa" id="kelurahan_kuasa" class="form-select form-control mb-2" data-control="select2" data-placeholder="Pilih Kelurahan">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                <input id="telp_kuasa" class="date-picker form-control mb-2" type="text" placeholder="Ex. 08998989809" name="telp_kuasa" value="<?php if($kkpr){echo $kkpr->telp_kuasa;}else{echo isset($draft_data['telp_kuasa']) ? $draft_data['telp_kuasa'] : '';} ?>">
                                <small>(Cantumkan No Telp. / HP / WA Pemohon <b>Bukan</b> Kuasa
                                    pengurusan)</small>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Fotokopi KTP Kuasa
                                <span class="required"></span>
                            </label>
                            <div class="col-md-9 col-sm-9 ">
                                <input type="file" id="alamat-pemohon" name="fotokopi_ktp_kuasa" class="form-control " accept=".jpg, .pdf">
                                <small>File yang diterima hanya .jpg dan .pdf</small>
                            </div>
                        </div>
                    </div>
                ...
                <div data-kt-stepper-element="content">
                    <div class="w-100">
                        ...
                        <!-- <div class="mb-3 row">
                            <label for="jumlah_kbli" class="col-form-label col-md-3 col-sm-3 label-align">Jumlah Surat KBLI dimohon<span class="required"></span></label>
                            <div class="col-md-9 col-sm-9 ">
                ...
                <div data-kt-stepper-element="content">
                    <div class="w-100">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                <input type="text" id="lokasi_tanah" value="<?php if($kkpr){echo $kkpr->lokasi_tanah;}else{echo isset($draft_data['lokasi_tanah']) ? $draft_data['lokasi_tanah'] : '';} ?>" name="lokasi_tanah" required="required" class="form-control ">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">RT</label>
                            <div class="col-md-9 col-sm-9 ">
                                <input class="form-control col" type="number" placeholder="Ex. 001" min="1" max="20" name="rt_tanah" id="rt_tanah" value="<?php if($kkpr){echo $kkpr->rt_tanah;}else{echo isset($draft_data['rt_tanah']) ? $draft_data['rt_tanah'] : '';} ?>" required>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">RW</label>
                            <div class="col-md-9 col-sm-9 ">
                                <input class="form-control col" type="number" placeholder="Ex. 001" min="1" max="20" name="rw_tanah" id="rw_tanah" value="<?php if($kkpr){echo $kkpr->rw_tanah;}else{echo isset($draft_data['rw_tanah']) ? $draft_data['rw_tanah'] : '';} ?>" required>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label class="col-form-label col-md-3 col-sm-3 label-align">Kota /
