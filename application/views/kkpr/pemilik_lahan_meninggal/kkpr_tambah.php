...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="stepper stepper-links d-flex flex-column pt-15" id="kt_create_account_stepper">
            ...
            <!--end::Nav-->
            <!--begin::Form-->
            <form class="mx-auto mw-800px w-100 pt-15 pb-10" id="kt_create_account_form" method="POST" action="<?php echo base_url('Kkpr/proses_tambah_kkpr_Pemilik_lahan_meninggal'); ?>" enctype="multipart/form-data">
                <!--begin::Step 1-->
