...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="stepper stepper-links d-flex flex-column pt-15" id="kt_create_account_stepper">
            ...
            <!--end::Nav-->
            <!--begin::Form-->
            <form class="mx-auto mw-800px w-100 pt-15 pb-10" id="kt_create_account_form" method="POST" action="<?php echo base_url('Kkpr/proses_tambah_kkpr_perumahan'); ?>" enctype="multipart/form-data">
                <!--begin::Step 1-->
                ...
                <div data-kt-stepper-element="content">
                    <div class="w-100">
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                <input type="file" id="alamat-pemohon" name="surat_tanah_tambah_dibawah_5000" class="form-control ">
                                <small>(untuk permohonan Perumahan luas total di bawah 5.000 m2).</small>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">
                                Peta Bidang (untuk surat tanah dibawah 5000 m2)
                                <br>
                                <small>sudah atas nama Pemohon, dan dilegalisir oleh BPN / Notaris </small>
                                <span class="required"></span>
                            </label>
                            <div class="col-md-9 col-sm-9 ">
                                <input type="file" id="alamat-pemohon" name="peta_bidang_tambah_dibawah_5000" class="form-control ">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">
                                Fotokopi surat tanah
                                <br>
                                <small>(Sertifikat Hak Guna Bangunan / Akta Pelepasan Hak Atas Tanah, sudah atas nama Pemohon (bertindak atas nama badan hukum), dan dilegalisir oleh BPN / Notaris )</small>
                                <span class="required"></span>
                            </label>
                            <div class="col-md-9 col-sm-9 ">
                                <input type="file" id="alamat-pemohon" name="surat_tanah_tambah_diatas_5000" class="form-control ">
                                <small>(untuk permohonan Perumahan luas total di atas 5.000 m2).</small>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">
                                Peta Bidang (untuk surat tanah diatas 5000 m2)
                                <br>
                                <small>sudah atas nama Pemohon (bertindak atas nama badan hukum), dan dilegalisir oleh BPN / Notaris </small>
                                <span class="required"></span>
                            </label>
                            <div class="col-md-9 col-sm-9 ">
                                <input type="file" id="alamat-pemohon" name="peta_bidang_tambah_diatas_5000" class="form-control ">
                            </div>
                        </div>
                        <div class="mb-3 row">
